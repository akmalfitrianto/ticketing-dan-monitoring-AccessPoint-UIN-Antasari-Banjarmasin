            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="position_x" x-model.number="position_x" @input="updatePreview()"
                                min="0" max="1000" required value="{{ old('position_x', $room->position_x) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                            ...
                            <input type="number" name="position_y" x-model.number="position_y" @input="updatePreview()"
                                min="0" max="600" required value="{{ old('position_y', $room->position_y) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500">
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <svg id="previewCanvas" viewBox="0 0 1000 600" class="w-full" style="height: 500px;">
                            ...
                            <g>
                                ...
                                <text :x="position_x + (width / 2)" :y="position_y + (height / 2)" text-anchor="middle"
                                    class="text-sm font-bold" fill="#0f766e" x-text="name">
                                </text>
                            </g>
                                ...
                                @foreach ($room->accessPoints as $ap)
                                    <g>
                                        <circle cx="{{ $room->position_x + $ap->position_x }}"
                                            cy="{{ $room->position_y + $ap->position_y }}" r="6"
                    ...
                    <div class="mt-4 space-y-3">
                        <!-- Statistics -->
                        <div class="p-3 bg-gradient-to-r from-blue-50 to-teal-50 border border-blue-200 rounded-lg">
                            <div class="grid grid-cols-2 gap-2 text-xs">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="text-gray-700">Sedang Diedit: <strong>{{ $room->name }}</strong></span>
                                </div>
                            </div>
                        </div>
                        ...
                        @if ($room->accessPoints()->count() > 0)
                            <div class="p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-xs text-yellow-800">
                                ...
                                <p>Ruangan ini memiliki <strong>{{ $room->accessPoints()->count() }} Access Point</strong>.
